...
def make_subclip(font, ttl_time, i_clip): 
    ...
    for j in range(SUBCLIP_INCR): 
        ...
        #print("Iterate: {}".format(j))
        #print("Start: {}".format(img_clip_j.start))
        pr#int("End: {}".format(img_clip_j.end)) 
        #print("Duration: {}".format(img_clip_j.duration))
        #print(type(j))
        #print("Add clip to queue") 
        img_queue.append(img_clip_j) 
        #print("Made img" + img_file_j) 
